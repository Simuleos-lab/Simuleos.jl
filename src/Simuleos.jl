...
using .WorkSession: @session_init, @session_store, @scope_inline, @scope_meta, @ctx_hash, @remember, @scope_capture, @session_commit, @session_batch_commit, @session_finalize, remember!
...
export @session_init, @session_store, @scope_inline, @scope_meta, @ctx_hash, @remember, @scope_capture, @session_commit, @session_batch_commit, @session_finalize
export @scope_expand
export remember!
