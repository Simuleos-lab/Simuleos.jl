...
**A**: Each subsystem should provide a lower-integrated (~I1x) base interface and, if needed, a higher-integrated (>I3x) user-facing interface. 
- this is a guideline
- The exact I-Axis level apply per-function.

**Q**: How to make integration levels explicit in code organization?
**A**: Group files by I-level with a consistent `*-I##.jl` naming scheme (e.g., `recorder-I1x.jl`, `settings-I3x.jl`).
